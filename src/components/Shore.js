...
const Shore = () => {
    ...
    const sources = [{src: 'CDFCG', url: '', title: 'Cool Deviantart', desc: "This site is included for the sake of completeness. It's essentially just a collection of images masquerading as a copy of deviantart."}, 
                    {src: 'OdinRecipes', url: 'odin-recipes', title: 'Odin Recipes', desc: "The first site I finished as part of the Odin Project. A simply site that navigates between a home page and three recipe pages."},
                    ...
                    {src: 'TicTacToe', url: 'tic-tac-toe', title: 'Tic-Tac-Toe', desc: "It's likely you've though to yourself, 'Why doesn't tic-tac-toe have a deep lore filled with complicated characters and suspensful stories?' Well, wonder no more. In this version of tic-tac-toe, you must aid Isaac, an apparent android who has been cursed to play the game until he has lost. Unfortunately for him, it seems he has also been cursed to play perfectly..."},
                    {src: 'Library', url: 'library', title: 'Library', desc: "An app that could theoretically track book which you've read. Includes some retro styling, and some randomly chosen cover art."},
                    ...
                    {src: 'MobileFirst', url: 'mobile-first', title: 'Mocchan and Jake', desc: "A simple app designed first for mobile. Learn the heartwarming tale of Mocchan, a precocious little girl, and Jake, her baseball bat."},
                    ...
                    {src: 'JSValidate', url: 'js-validate', title: 'JS Validate', desc: "A simple validation form that used Javascript for custom validation parameters. The background image changes based on current amount a valid fields."},
                    {src: 'HearthstoneAPI', url: 'hearthstone-api', title: 'Hearthstone API', desc: "A game which tests your memory of hearthstone card costs. Yes, this site looks ugly. As of writing this, this site does not use an API. It did originally, but the API went down during developement, so its data was replaced with static data."},
                    {src: 'Battleship', url: 'battleship', title: 'Battleship', desc: "A game of battleship where you are accompanied by five doting shipgirls. Don't fail them, or they will react in kind. Includes some art by me and some 'borrowed' art."},
                    {src: 'CVProject', url: 'cv-project', title: 'CVGenDUO', desc: "A resume building app. Enter some basic info to create a simple resume. Then, click the button labeled, 'click me' to be greeted with a modern digital resume fit for you, a king, but also an expert NFT bro and trader."},
                    {src: 'MemoryCard', url: 'memory-card-real', title: 'Memory Card', desc: "An API-based game of memory. Click each card in a set of 9 once, but the cards shuffle between each click. Card API takes from the Modern Masters magic set."},
                    {src: 'ShoppingCart', url: 'shopping-cart', title: 'laythere.ca', desc: "Remember that thing wayfair was accused of with trafficking children via expensive furniture? This is if that actually happened. Browse a handful of listings, and then add your favourites to your cart! Or, if you like, create a new listing based on a keyword, which will generate a wayfair clone page with an image taken from the upsplash API."},
                    ...
                    {src: 'NubeClicker', url: 'js-final-project', title: 'Nube', desc: "A mobile-focused app in which you buy and sell Bored Apes. Finally, funged tokens in the palm of your hand. Of course, these aren't 'official' apes, but isn't the feeling of 'right-click -> save as' much more empowering? Play a minigame where you mine resources from space as a cyber-angel to earn coins for the store. Sign-in with google, and your account info can be tracked with firebase."}];
        ...
        <div id='shore'>
            <div id='mikobox'>
                ...
                <div id='fishrack' style={{ backgroundImage: `url(${fishRack})` }}>
                    ...
                    <button id='rackreturnbtn' onClick={toggleExpandedRack}>back</button>
                </div>
